...
let squidImg = document.getElementById("js--squidImg");

let squidGreen = document.getElementById("js--squidGreen");
let squidPurple = document.getElementById("js--squidPurple");
let squidHat = document.getElementById("js--squidHat");

squidGreen.onclick = function(){
    squidImg.setAttribute("src", "img/squid.webp");
    squidGreen.style.border = "0.2rem solid black";
    squidPurple.style.border = "none";
    squidHat.style.border = "none";
    
}

squidPurple.onclick = function(){
    squidImg.setAttribute("src", "img/squidPurple.webp");
    squidPurple.style.border = "0.2rem solid black";
    squidGreen.style.border = "none";
    squidHat.style.border = "none";
}

squidHat.onclick = function(){
    squidImg.setAttribute("src", "img/squidHat.webp");
    squidHat.style.border = "0.2rem solid black";
    squidPurple.style.border = "none";
    squidGreen.style.border = "none";
}
